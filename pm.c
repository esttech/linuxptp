...
static struct pm_port_counters * calloc_new_counter_record()
{
...
static struct pm_clock_stats * add_new_24_clock_stats_record(struct pm_clock_recordlist *rl)
{
...
static struct pm_port_stats * add_new_24_port_stats_record(struct pm_port_recordlist *rl)
{
...
static struct pm_port_counters * add_new_24_counter_record(struct pm_port_recordlist *rl)
{
	struct pm_port_counters *cr = calloc_new_counter_record();
...
static struct pm_clock_stats * get_current_24_clock_stats_record(struct pm_clock_recordlist *rl)
{
...
static struct pm_port_stats * get_current_24_port_stats_record(struct pm_port_recordlist *rl)
{
...
static struct pm_port_counters * get_current_24_counter_record(struct pm_port_recordlist *rl)
{
...
static void extract_counter_data(struct pm_port_counters *cr,
